        ...
        <div className='py-10 px-5 lg:px-20 rounded-lg mt-20 flex bg-linear-to-tl from-orange-300 via-orange-200 to-orange-300 flex-col-reverse md:flex-row lg:flex-row items-center justify-between'>
            ...
            <div className='space-y-5 w-full md:w-1/2' >
                ...
                <div className='flex gap-5 items-center'>
                    <Link to='/allJobs' className='btn bg-linear-to-r from-orange-300 to-orange-600 text-white'>
                        Explore Jobs
                    </Link>
                    <Link to='/addJob' className='btn bg-linear-to-r from-orange-300 to-orange-600 text-white'>
                        Create a Job
                    </Link>
                </div>
            </div>
