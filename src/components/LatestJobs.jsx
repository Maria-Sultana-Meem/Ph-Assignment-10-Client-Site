...
const LatestJobs = ({ job }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col mt-3 space-y-2">
      ...
      <Link
        to={`/allJobs/${_id}`}
        className="btn bg-linear-to-r from-orange-300 to-orange-600 text-white w-full hover:scale-105 transition-transform duration-300 mt-auto"
      >
        View Details
