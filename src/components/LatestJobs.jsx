    ...
    return (
        <div className='shadow-sm hover:shadow-2xl space-y-2 rounded-lg p-6 hover:scale-105 transform transition ease-in-out'>
            ...
            <h1 className='font-semibold '>Title: <span className='text-orange-400'>{title}</span></h1>
                ...
                <p className='font-semibold text-gray-600 text-sm'>PostedBy:{postedBy}</p>
                <p className='text-xs text-gray-900'>Email:{userEmail}</p>
                <p className='text-gray-700 text-sm'>{summary}</p>
                <button className='btn bg-linear-to-r from-orange-300 to-orange-600 text-white w-full hover:scale-105 transition-transform duration-300'>View Details<FaArrowUpRightFromSquare /></button>
